...
INSTALLER_EXPORT Q_DECLARE_LOGGING_CATEGORY(lcInstallerPluginLog)
...
bool INSTALLER_EXPORT containsReservedCharacters(QString *message, const QStringList &packageEntryList);
